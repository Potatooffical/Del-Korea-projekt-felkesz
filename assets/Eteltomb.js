const eteltomb = [
  {
    neve: "Jjajangmyeon (짜장면)",
    tipusa: "tésztaalapú étel",
    leiras:
  ...
  },
  {
    neve: "Tangsuyuk (탕수육)",
    tipusa: "",
    leiras: "Még egy kínai-koreai eredetű étel, amit édes-savanyú ízeiért szeretnek. Bundában kisütött sertéshús-falatkákat tálalnak ízletes édes szószban, amibe sokszor hagymát, répát és néha akár ananászt vagy egyéb gyümölcsöt is kevernek. A jjajangmyeon mellé, vagy önmagában is fogyaszthatjuk.",
    kep: "3.png",
  },
  {
    neve: "Tteokbokki (떡볶이)",
    tipusa: "tésztaalapú étel",
    leiras: "A tteokbokival gyakran találkozhatunk filmekben és sorozatokban, hiszen az utcai árusok legnépszerűbb ételéről és a koreaiak egyik kedvenc street foodjáról beszélünk. A cső alakú rizstészta-rudakat csilikrémből készült szószban tálalják és sokszor hagymát, halpogácsát és főtt tojást is adnak az ízletes fogáshoz. A tteokbokki olcsó, finom, könnyen elkészíthető étel, de fel kell készülni arra, hogy a csilikrém bizony nagyon csípős!",
    kep: "4.png",
  },
  {
    neve:"Gamjatang (감자탕)",
    tipusa:"tesztaleves",
    leiras:"A sertéshús csontjából készült levesben krumplit, káposztát és zöldségeket is találunk a hús mellett. Ezt a nagyon egészséges ételt sokszor rizzsel fogyasztják a téli hónapokban, a magyar emberek húsleveshez szokott gyomrához pedig tökéletesen passzol majd ez a fogás!",
    kep:"5.png",
  },
  {
    neve:"Hanwoo és Samgyeopsal (한우/삼겹살)",
    tipusa:"",
  ...
  {
    neve:"A koreai sült csirke",
    tipusa:"Húsétel",
    leiras:"Azt gondolnánk, hogy a sült csirkét mindenhol ugyanúgy fogyasztják a világon, de nem ez a helyzet a koreai csirkével, ahol többfajta szószban és módon kisütött csirkét is megkóstolhatunk. Találhatunk itt csípős és kevésbé csípős szószban megforgatott csirkét, újhagymás sült csirkét és a népszerű mézes-vajas ízű csirkét is. Ahogy a koreaiaknak, nekünk is nagyon jól fog esni egy korsó hideg sör a finom húsok mellé!",
    kep:"7.png",
  },
  {
    neve:"Naengmyeon (냉면)",
    tipusa:"leves",
    leiras:"A naengmyeon hideg tésztaétel, a hajdinatésztát hideg, frissítő húsleveslében tálalják. Természetesen ez a nyári hónapokban tökéletes étel, és hogy még frissítőbb legyen, megbolondíthatjuk japán retekkel, körtével, főttt tojással és hússal is, a tetejére pedig ecetet vagy mustárt is önthetünk.",
    kep:"8.png",
  },
  {
    neve:"Kimchi bokkeumbap (김치볶음밥)",
    tipusa:"riszes étel",
